import{buildFieldTransform,chooseNearestPitch,normalizeAttackU}from'./field-transform.js';
...
function buildPosition(samples,{attackDirection=1,field=null,periods=[],firstPeriodAttack=null}={}){
  ...
  const fieldCalibrated=!!fieldTf,periodList=Array.isArray(periods)?periods:[],first=Number(firstPeriodAttack),canOrient=fieldCalibrated&&(first===1||first===-1)&&periodList.length>0;
